 ...
 * Generated for Laravel 5.6.35 on 2018-09-06 14:11:47.
 *
...
namespace App\Facades { 
    ...
    class Activity {
        ...
        {
            return \App\Services\ActivityService::log($message, $module);
        }
         ...
         * @static 
         */ 
        public static function logAs($message, $user, $module = null)
        {
            return \App\Services\ActivityService::logAs($message, $user, $module);
        }
...
namespace  { 
    ...
    class Activity extends \App\Facades\Activity {}
